...
- 题目：StylizedNeRF：通过2D-3D相互学习将3D场景风格化为风格化NeRF
...
- 题目：Mega-NeRF：用于虚拟飞越的大规模NeRF的可扩展构造
...
- 题目：AR-NeRF：从具有孔径渲染神经辐射场的自然图像中无监督地学习深度和散焦效应
...
- 题目：暗环境中的NeRF：从嘈杂的原始图像合成高动态范围视图
...
- 题目：Aug-NeRF：使用三级物理接地增强训练更强的神经辐射场
...
- 题目：DoubleField：桥接神经表面和辐射场以实现高保真人体重建和渲染
...
- 题目：Pix2NeRF：用于单图像到神经辐射场转换的无监督条件$\pi$-GAN
...
- 题目：通过重投影的射线先验：改进神经辐射场以进行新的视图外推
...
- 题目：RegNeRF：正则化神经辐射场以从稀疏输入进行视图合成
...
- 题目：用于实时动态辐射场渲染的Fourier PlenOctrees
...
- 题目：DIVeR：实时和准确的神经辐射场，具有用于体积渲染的确定性集成
